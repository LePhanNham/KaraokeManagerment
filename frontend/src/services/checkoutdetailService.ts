...
/**
 * Service để xử lý logic cho Chi tiết thanh toán
 */
export const checkoutdetailService = {
  ...
  getData: async (): Promise<any[]> => {
    try {
      ...
      // const response = await api.get('/api/checkoutdetail');
      ...
      console.error('Error getting checkoutdetail data:', error);
      throw new Error(error.message || 'Lỗi khi tải dữ liệu chi tiết thanh toán');
    }
  },
  ...
  create: async (data: any): Promise<any> => {
    try {
      // TODO: Implement API call
      // const response = await api.post('/api/checkoutdetail', data);
      // if (response.data.success) {
      //   return response.data.data;
      // }
      ...
      console.error('Error creating checkoutdetail:', error);
  ...
  update: async (id: number, data: any): Promise<any> => {
    try {
      // TODO: Implement API call
      // const response = await api.put(`/api/checkoutdetail/${id}`, data);
      // if (response.data.success) {
      //   return response.data.data;
      // }
      ...
      console.error('Error updating checkoutdetail:', error);
  ...
  delete: async (id: number): Promise<boolean> => {
    try {
      // TODO: Implement API call
      // const response = await api.delete(`/api/checkoutdetail/${id}`);
      // if (response.data.success) {
      //   return true;
      // }
      ...
      console.error('Error deleting checkoutdetail:', error);
